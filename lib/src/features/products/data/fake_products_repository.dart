...
Future<void> logProductViewDurationToAnalytics({
...
Stream<Product?> product(Ref ref, ProductID id) {
  ...
  // เริ่มจับเวลาเมื่อเริ่มดูหน้า Product
  ...
  ref.onDispose(() async {
    ...
    await logProductViewDurationToAnalytics(productId: id, duration: duration);
  });
